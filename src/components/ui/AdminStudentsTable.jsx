function AdminStudentsTable({ students, onViewDetails }) {
  return (
                ...
                <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        (student.requirementsCompleted === student.totalRequirements && student.totalRequirements > 0 && student.endorsementStatus === 'completed')
                          ? 'bg-green-100 text-green-800'
                          : (student.requirementsCompleted === student.totalRequirements && student.totalRequirements > 0)
